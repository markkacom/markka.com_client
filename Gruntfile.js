...
module.exports = function (grunt) {
  ...
  grunt.registerTask('build-release', [], function (target) {
    var version = grunt.file.read('VERSION');
    var build_timestamp_seconds = Math.floor(Date.now() / 1000);
    var content =
...
var DEBUG=false;
var BUILD_TIMESTAMP=${build_timestamp_seconds};`;
    grunt.file.write('app/mode.js', content);

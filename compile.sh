...
# FIM embedded in lompsa
mkdir -p $BUILD/lompsa.app/Contents/Resources/fim
mkdir -p $BUILD/lompsa.app/Contents/Resources/fim/conf
cp -r -p $FIM_FILES $BUILD/lompsa.app/Contents/Resources/fim
cp -p $FIM_FILES_CONF $BUILD/lompsa.app/Contents/Resources/fim/conf

# NXT embedded in lompsa
if [ "$WITH_NEXT" = "true" ]; then
  mkdir -p $BUILD/lompsa.app/Contents/Resources/nxt
  mkdir -p $BUILD/lompsa.app/Contents/Resources/nxt/conf
  cp -r -p $NXT_FILES $BUILD/lompsa.app/Contents/Resources/nxt
  cp -p $NXT_FILES_CONF $BUILD/lompsa.app/Contents/Resources/nxt/conf
fi
...
ANNOUNCEMENT="announcements/lompsa-$VERSION.txt"

...
module.run(function (modals, settings) {
  modals.register('login-to', { 
    templateUrl: 'partials/login-to-modal.html', 
    controller: 'LoginToModalController' 
  });
});
module.controller('LoginToModalController', function (items, $scope, $modalInstance, $rootScope, 
  KeyService, nxt, $q, $location, $timeout, db, timeagoService, diceWords) {

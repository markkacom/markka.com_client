...
module.factory('AccountColorAutocompleteProvider', function (nxt, $q, $rootScope) {
  function AccountColorAutocompleteProvider(api) {
    this.api = api;
  }
  AccountColorAutocompleteProvider.prototype = {
  ...
  return AccountColorAutocompleteProvider;
});
})();